...
car_racing.reinforcement_learning_configuration.training_name = 'car_racing_2'
...
car_racing.reinforcement_learning_configuration.evaluation_num_environment_runners = 2
...
car_racing.reinforcement_learning_configuration.train_batch_size = 512 * 8
car_racing.reinforcement_learning_configuration.compress_observations = True
car_racing.reinforcement_learning_configuration.minibatch_size = 512
